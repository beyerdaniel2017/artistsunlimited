        ...
        .then(function(sub) {
          Channel.find({
            ...
            .then(function(channels) {
              ...
              var acceptEmail = {};
              if(req.user.customEmailButtons && req.user.customEmailButtons.length > 0){
                acceptEmail = req.user.customEmailButtons.find(function(body) {
                  return body.buttonText == "accept";
                });
              }
              var body = acceptEmail.emailBody;
