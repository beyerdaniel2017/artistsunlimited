      ...
      scWrapper.request(reqObj, function(err, data) {
        if (!err) {
          ...
          event.save().then(function(event) {
            ...
            notificationCenter.sendNotifications(user._id, 'trackRepost', 'Track repost', event.title ? event.title : 'A track' + ' was reposted on ' + user.soundcloud.username, 'https://artistsunlimited.com/login');
